...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{asset('lex_admin/assets/media/favicons/favicon-192x192.png')}}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('lex_admin/assets/media/favicons/apple-touch-icon-180x180.png')}}">
    <!-- END Icons -->
...
<!-- END Side Overlay -->
    ...
    <!-- Sidebar -->
@include('lawyer.inc.sidebar')
<!-- END Sidebar -->

    <!-- Header -->
@include('lawyer.inc.header')
<!-- END Header -->
