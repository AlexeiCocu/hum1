        ...
        <div class="content-header content-header-fullrow px-15">
            ...
            <div class="content-header-section sidebar-mini-visible-b">
                ...
                <span class="content-header-item font-w700 font-size-xl float-left animated fadeIn">
                                <span class="text-dual-primary-dark">7</span><span class="text-primary">lex</span>
                            </span>
                <!-- END Logo -->
            </div>
            <!-- END Mini Mode -->
            ...
            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                ...
                <div class="content-header-item">
                    <a class="link-effect font-w700" href="{{route('lawyer-index')}}">
{{--                        <i class="si si-fire text-primary"></i>--}}
                        <img src="{{asset('lex_admin/assets/media/icons/logo.svg')}}" alt="7lex logo">
        ...
        <div class="content-side content-side-full bg-body-light">
            <a href="{{route('lawyer-clients.create')}}" type="button" class="btn btn-sm btn-block btn-hero btn-alt-primary" data-toggle="click-ripple">
                <i class="fa fa-user-plus mr-5"></i> New Client
            </a>
        </div>
        <!-- END New Account -->
        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                <li>
                    <a class="active" href="{{route('lawyer-clients.index')}}"><i class="si si-users"></i>
                        <span class="sidebar-mini-hide">Clients
