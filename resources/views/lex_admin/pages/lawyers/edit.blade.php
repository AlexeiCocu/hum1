...
@section('content')
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    <i class="fa fa-user-circle mr-5 text-muted"></i> Lawyer Profile
                </h3>
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    <i class="fa fa-user-circle mr-5 text-muted"></i> Lawyer Profile Data
                </h3>
            </div>
            <div class="block-content">
                <form action="{{route('admin-lawyers.update', $lawyer->id)}}" enctype="multipart/form-data" method="POST" >
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-7 offset-lg-1">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="profile-settings-name" name="phone" placeholder="Enter your phone.." value="{{$lawyer->phone}}" onkeydown="javascript:backspacerDOWN(this,event);" onkeyup="javascript:backspacerUP(this,event);">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
